...
ob_start();
file_put_contents(getenv("TMPDIR") . '/source', stream_get_contents($handles['user_source']) );
system('phpcs.phar ' . getenv("TMPDIR") . '/source');
$return = ob_get_contents();
ob_end_clean();
fwrite($handles['p_info'], $return, strlen($return));
